...
master = open(os.path.join(HERE, "under-the-hood.html")).read()

PARTS = [
    ("under-the-hood-1-parts.html",   "Part 1 · The Parts — switch → gates → adder",      [0, 1, 2, 3]),
    ("under-the-hood-2-memory.html",  "Part 2 · Memory & Time — the loop and the bell",   [4, 5]),
    ("under-the-hood-3-machine.html", "Part 3 · The Machine — and the whole ladder",      [6, 7]),
]
